...
urlpatterns = [
    ...
    url(r'^Predict_Drink_Driving_Detection/$', remoteuser.Predict_Drink_Driving_Detection, name="Predict_Drink_Driving_Detection"),
    ...
    url(r'^View_Prediction_Of_Drink_Driving_Detection_Ratio/$', serviceprovider.View_Prediction_Of_Drink_Driving_Detection_Ratio, name="View_Prediction_Of_Drink_Driving_Detection_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Drink_Driving_Detection/$', serviceprovider.View_Prediction_Of_Drink_Driving_Detection, name="View_Prediction_Of_Drink_Driving_Detection"),
